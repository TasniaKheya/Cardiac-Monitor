    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(v -> {
            ...
            if (isAllFieldsChecked) {
                ...
                Toast.makeText(AddDetails.this,"Record added successfully!",Toast.LENGTH_SHORT).show();
    ...
    private void datePicker()
    {
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(AddDetails.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, onDateSetListener,
                        year, month, day);
    ...
    private void timePicker() {
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //calendar.clear();
                TimePickerDialog dialog =  new TimePickerDialog(AddDetails.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
