...
/*        date.setText(record.getDate());
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (isAllFieldsChecked) {
                ...
                record = new ModelClass(dateString,timeString,sysInt,diasInt,heartInt,commentStr);
                ...
                saveData();
                Toast.makeText(UpdateDetails.this,"Updated successfully!",Toast.LENGTH_SHORT).show();
    ...
    private void datePicker()
    {
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(UpdateDetails.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, onDateSetListener,
                        year, month, day);
    ...
    private void timePicker() {
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //calendar.clear();
                TimePickerDialog dialog =  new TimePickerDialog(UpdateDetails.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
